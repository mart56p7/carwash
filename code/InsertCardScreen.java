...
public class InsertCardScreen extends JPanel
{
   ...
   public InsertCardScreen(WashHallGUI _gui)
   {
      ...
      accountField.setBounds(832,_gui.getHeight()/2+50,256,30);
      ...
      simbutton.setBounds(_gui.getWidth()/2-(int)(simbuttonlabelsize.getWidth()/2)-20,_gui.getHeight()/2-(int)(simbuttonlabelsize.getHeight()/2)+100,(int)simbuttonlabelsize.getWidth()+40,(int)simbuttonlabelsize.getHeight());
      ...
      accountField.setText("Write account id");
   }
